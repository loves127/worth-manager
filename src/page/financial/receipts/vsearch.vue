<template>
  <el-form :inline="true" class="demo-form-inline">
    ...
    <el-form-item label="账户名称">
      <el-select v-model="search.accountName" placeholder="账户名称" style="width: 130px"
                 @change="$emit('changeAccount',search.accountName)">
    ...
    <el-form-item style="float: right">
      <el-button type="primary" @click="$emit('openDialog','新增收入')">新增</el-button>
    </el-form-item>
  </el-form>
</template>
