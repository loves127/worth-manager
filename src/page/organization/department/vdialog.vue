  ...
  <el-dialog
    ...
    <el-form :model="form" :label-position="labelPosition">
      <el-form-item label="部门名称" :label-width="formLabelWidth">
        <el-input v-model="form.name" auto-complete="off" placeholder="请输入部门名称"/>
      </el-form-item>
      <el-form-item label="部门简介" :label-width="formLabelWidth">
        <el-input type="textarea" :rows="5" v-model="form.desc" auto-complete="off" placeholder="请输入部门简介"/>
      </el-form-item>
    </el-form>
...
<script>
  ...
  export default {
    props:['centerDialogVisible','form','panelTitle'],
    components: {
      ElButton: Button,
      ElForm: Form,
      ElFormItem: FormItem,
